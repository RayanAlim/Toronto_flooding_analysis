...
author: 
  - Rayan Awad Alim
thanks: "Code and data are available at: https://github.com/RayanAlim/Toronto_flooding_analysis"
date: today
date-format: long
...
Although similar datasets could have been used, such as datasets on rainfall, soil drainage, or infrastructure quality, the focus on service requests provides a direct measure of citizen-reported issues. Which aligns with the goals of the analysis of identifying areas for tageted govermental intervention. 

# Discussion

## Increasing service requests

Summary statistics show us that service requests have generally increased over time, with certain years (corresponding to major storm events) seeing spikes in the number of reported issues.
